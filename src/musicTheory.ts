...
export const CHORD_LEGEND = [
  { symbol: '(none)', example: 'C', name: 'Major', description: 'Major triad: root, major 3rd, perfect 5th' },
  { symbol: 'm', example: 'Cm', name: 'Minor', description: 'Minor triad: root, minor 3rd, perfect 5th' },
  { symbol: '°', example: 'C°', name: 'Diminished', description: 'Diminished triad: root, minor 3rd, diminished 5th' },
  { symbol: '+', example: 'C+', name: 'Augmented', description: 'Augmented triad: root, major 3rd, augmented 5th' },
  { symbol: 'maj7', example: 'Cmaj7', name: 'Major 7th', description: 'Major triad plus major 7th' },
  { symbol: 'm7', example: 'Cm7', name: 'Minor 7th', description: 'Minor triad plus minor 7th' },
  { symbol: '7', example: 'C7', name: 'Dominant 7th', description: 'Major triad plus minor 7th, the dominant sound' },
  { symbol: '°7', example: 'C°7', name: 'Diminished 7th', description: 'Diminished triad plus diminished 7th' },
  { symbol: 'ø7', example: 'Cø7', name: 'Half-diminished 7th', description: 'Diminished triad plus minor 7th, also written m7♭5' },
  { symbol: 'sus2', example: 'Csus2', name: 'Suspended 2nd', description: 'Root, major 2nd, and 5th, no 3rd' },
  { symbol: 'sus4', example: 'Csus4', name: 'Suspended 4th', description: 'Root, perfect 4th, and 5th, no 3rd' },
  { symbol: 'add9', example: 'Cadd9', name: 'Add 9', description: 'Major triad plus a 9th above the root' },
]
